...
<?php $__env->startSection('title', 'Muebleria Vanguardia - Detalles del producto'); ?>
...
<div class="container-fluid bg-white rounded shadow"><br>
    ...
    <div class="row">
        <div class="col-md-6 order-md-1">
            <center>
            <img src="<?php echo e(asset($producto->imagen)); ?>" alt="" class="img-fluid">
            </center>
        </div>
        <div class="col-md-6 order-md-2">
            <h2 style="font-weight:600;"><?php echo e($producto->descripcion); ?></h2>
            <h2><?php echo e($producto->precio_unitario); ?></h2>
            <p class="lead">
    ...
    paypal.Buttons({
        ...
        createOrder: function(data, actions){
            return actions.order.create({
                purchase_units: [{
                    amount: {
                        value: <?php echo e($producto->precio_unitario); ?>
...
<?php echo $__env->make('layout/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\DWI-SHU3\resources\views/productos/show.blade.php ENDPATH**/ ?>