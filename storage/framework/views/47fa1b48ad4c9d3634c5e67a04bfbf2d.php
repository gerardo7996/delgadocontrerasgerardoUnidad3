...
<?php $__env->startSection('title', 'Muebleria Vanguardia - Catálogo de productos'); ?>
...
<nav class="navbar  fixed-top  navbar-expand-lg navbar-dark" style="background: hsla(0, 0%, 10%, 0.55); backdrop-filter: blur(10px);">
    <div class="container-fluid">
        ...
        <a class="d-flex btn btn-info" href="<?php echo e(url('productos/login')); ?>"><i class="bi bi-backspace"></i><strong>Regresar</strong></a>
    </div>
</nav>
<br><br>
<?php $__env->stopSection(); ?>
...
<div class="container-fluid bg-white rounded shadow"><br>
    ...
    <a href="<?php echo e(url('productos/create')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-patch-plus-fill" style="margin-right:7.5px;"></i>Nuevo producto</a><br><br>
    <div class="table-responsive">
        <table id="tblProductos" class="table table-striped table-bordered" style="width:100%;">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row" style="color: #000000; font-weight: 600;"><?php echo e($producto->id_producto); ?></th>
                    ...
                    <td>
                        <center>
                            <img src="<?php echo e(asset($producto->imagen)); ?>" alt="<?php echo e($producto->descripcion); ?>" class="img-fluid" width="100px">
                        </center>
                    </td>
                    <td>
                        <center>
                            <a href="<?php echo e(url('productos/'.$producto->id_producto)); ?>" class="btn btn-info"><i class="bi bi-info-circle-fill"></i></a>
                            <form action="<?php echo e(url('productos/'.$producto->id_producto)); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\DWI-SHU3\resources\views/productos/index.blade.php ENDPATH**/ ?>