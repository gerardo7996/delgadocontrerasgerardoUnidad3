<nav class="navbar  fixed-top  navbar-expand-lg navbar-dark" style="background: hsla(0, 0%, 10%, 0.55); backdrop-filter: blur(10px);">
    <div class="container-fluid">
        ...
        <a class="d-flex btn btn-info" href="<?php echo e(url('productos')); ?>"><i class="bi bi-backspace"></i><strong>Regresar</strong></a>
    </div>
</nav>
<br><br><?php /**PATH D:\XAMPP\htdocs\DWI-SHU3\resources\views/layout/navbar.blade.php ENDPATH**/ ?>