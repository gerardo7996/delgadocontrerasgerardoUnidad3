...
<?php $__env->startSection('title', 'Muebleria Vanguardia - Nuevo Producto'); ?>
    ...
    <form class="row" id="new_product_form" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-6">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="codigo" id="codigo" value="<?php echo e(old('codigo')); ?>" aria-label="codigo" aria-describedby="addon-wrapping">
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="descripcion" id="descripcion" value="<?php echo e(old('descripcion')); ?>" aria-label="descripcion" aria-describedby="addon-wrapping">
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text"  class="form-control" name="precio_unitario" id="precio_unitario"  value="<?php echo e(old('precio_unitario')); ?>" aria-label="precio_unitario" aria-describedby="addon-wrapping">
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="cantidad" id="cantidad" value="<?php echo e(old('cantidad')); ?>" aria-label="stock" aria-describedby="addon-wrapping">
            </div>
        </div>
        <div class="col-12">
                    ...
                    success: function(resultado) {
                        if (resultado==1) {
                            ...
                            Swal.fire(
                                ...
                                window.location.href = '<?php echo e(url("productos")); ?>';
                                $('#codigo').val('');
                                $('#descripcion').val('');
                                $('#precio_unitario').val('');
                                $('#cantidad').val('');
...
<?php echo $__env->make('layout/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\DWI-SHU3\resources\views/productos/create.blade.php ENDPATH**/ ?>